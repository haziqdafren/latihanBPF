...
function Spacing() {
    return (
        <div className="bg-white shadow-lg p-6 m-4 rounded-lg">
            ...
            <p className="mt-2 text-gray-600">Ini adalah contoh penggunaan Padding dan margin dalam tailwind</p>
        </div>
    );
}
...
function Typography() {
    return (
        <div>
            ...
            <p className="text-gray-600 text-lg mt-2">Belajar Tailwind sangat menyenangkan dan mudah!</p>
        </div>
    );
}
...
function BorderRadius() {
    return (
        <button className="border-2 border-blue-500 text-blue-500 px-4 rounded-lg">Klik Saya</button>
    );
}
